	...
	internal static class VanillaEncounterImportModal
	{
		...
		private static void Import(string templateName)
		{
			...
			statusLabel.SetText(string.Format(
				...
				"Imported to {0}. {1} hero, {2} enemy spawns; {3} cinematic dropped, {4} gated, {5} out of bounds.",
				result.Folder, result.HeroesImported, result.EnemiesImported,
			...
			LokrLabPlugin.Log.LogInfo(string.Format(
				System.Globalization.CultureInfo.InvariantCulture,
				"Vanilla encounter import '{0}' -> {1}: {2} hero, {3} enemy, {4} cinematic dropped, {5} gated, {6} out of bounds, {7} EncounterDefinition variant(s), {8} Bkg variant(s).",
